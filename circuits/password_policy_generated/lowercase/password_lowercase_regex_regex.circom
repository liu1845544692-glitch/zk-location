...
// regex: ^P[A-Za-z0-9!@#$%^&*]*[a-z][A-Za-z0-9!@#$%^&*]*;$
template PasswordLowercaseRegexRegex(maxHaystackBytes, maxMatchBytes) {
    ...
    for (var i = 0; i < maxMatchBytes; i++) {
        ...
        // Transition 9: 2 -[97-122]-> 3
        isValidTransition[9][i] <== CheckByteRangeTransition()(2, 3, 97, 122, currStates[i], nextStates[i], haystack[i]);
