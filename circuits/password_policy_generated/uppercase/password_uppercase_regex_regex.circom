...
template PasswordUppercaseRegexRegex(maxHaystackBytes, maxMatchBytes) {
    ...
    for (var i = 0; i < maxMatchBytes; i++) {
        ...
        // Transition 9: 2 -[65-90]-> 3
        isValidTransition[9][i] <== CheckByteRangeTransition()(2, 3, 65, 90, currStates[i], nextStates[i], haystack[i]);
