   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.INSTANCE.ffi_zk_location_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.INSTANCE.ffi_zk_location_rustbuffer_free(buf, status)
        }
    }
...
fun uniffi_zk_location_checksum_func_generate_location_cell_boundary(
): Short
fun uniffi_zk_location_checksum_func_generate_location_circuit_input(
): Short
...
fun uniffi_zk_location_checksum_func_verify_circom_proof(
): Short
fun uniffi_zk_location_checksum_func_verify_halo2_proof(
): Short
fun uniffi_zk_location_checksum_func_verify_noir_proof(
): Short
fun ffi_zk_location_uniffi_contract_version(
): Int
...
fun ffi_zk_location_rust_future_cancel_u8(`handle`: Long,
): Unit
...
fun ffi_zk_location_rust_future_cancel_i8(`handle`: Long,
): Unit
...
fun ffi_zk_location_rust_future_cancel_u16(`handle`: Long,
): Unit
...
fun ffi_zk_location_rust_future_cancel_i16(`handle`: Long,
): Unit
...
fun ffi_zk_location_rust_future_cancel_u32(`handle`: Long,
): Unit
...
fun ffi_zk_location_rust_future_cancel_i32(`handle`: Long,
): Unit
...
fun ffi_zk_location_rust_future_cancel_u64(`handle`: Long,
): Unit
...
fun ffi_zk_location_rust_future_cancel_i64(`handle`: Long,
): Unit
...
fun ffi_zk_location_rust_future_cancel_f32(`handle`: Long,
): Unit
...
fun ffi_zk_location_rust_future_cancel_f64(`handle`: Long,
): Unit
...
fun ffi_zk_location_rust_future_cancel_pointer(`handle`: Long,
): Unit
...
fun ffi_zk_location_rust_future_cancel_rust_buffer(`handle`: Long,
): Unit
...
fun ffi_zk_location_rust_future_cancel_void(`handle`: Long,
): Unit
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_zk_location_uniffi_contract_version()
...
public object FfiConverterMapStringSequenceString: FfiConverterRustBuffer<Map<kotlin.String, List<kotlin.String>>> {
    ...
    UniffiLib.INSTANCE.uniffi_zk_location_fn_func_generate_circom_proof(
    ...
    uniffiRustCallWithError(MoproException) { _status ->
    UniffiLib.INSTANCE.uniffi_zk_location_fn_func_generate_halo2_proof(
    ...
    uniffiRustCallWithError(MoproException) { _status ->
    UniffiLib.INSTANCE.uniffi_zk_location_fn_func_generate_location_cell_boundary(
        FfiConverterDouble.lower(`lat`),FfiConverterDouble.lower(`lon`),FfiConverterUByte.lower(`resolution`),_status)
}
    )
    }
    ...
    @Throws(MoproException::class) fun `generateLocationCircuitInput`(`lat`: kotlin.Double, `lon`: kotlin.Double, `resolution`: kotlin.UByte): kotlin.String {
            return FfiConverterString.lift(
    uniffiRustCallWithError(MoproException) { _status ->
    UniffiLib.INSTANCE.uniffi_zk_location_fn_func_generate_location_circuit_input(
        FfiConverterDouble.lower(`lat`),FfiConverterDouble.lower(`lon`),FfiConverterUByte.lower(`resolution`),_status)
}
    )
    }
    ...
    uniffiRustCallWithError(MoproException) { _status ->
    UniffiLib.INSTANCE.uniffi_zk_location_fn_func_generate_noir_proof(
    ...
    @Throws(MoproException::class) fun `getNoirVerificationKey`(`circuitPath`: kotlin.String, `srsPath`: kotlin.String?, `onChain`: kotlin.Boolean, `lowMemoryMode`: kotlin.Boolean): kotlin.ByteArray {
            return FfiConverterByteArray.lift(
    uniffiRustCallWithError(MoproException) { _status ->
    UniffiLib.INSTANCE.uniffi_zk_location_fn_func_get_noir_verification_key(
    ...
    UniffiLib.INSTANCE.uniffi_zk_location_fn_func_mopro_hello_world(
        _status)
}
    )
    }
    ...
    uniffiRustCallWithError(MoproException) { _status ->
    UniffiLib.INSTANCE.uniffi_zk_location_fn_func_verify_circom_proof(
    ...
    @Throws(MoproException::class) fun `verifyHalo2Proof`(`srsPath`: kotlin.String, `vkPath`: kotlin.String, `proof`: kotlin.ByteArray, `publicInput`: kotlin.ByteArray): kotlin.Boolean {
            return FfiConverterBoolean.lift(
    uniffiRustCallWithError(MoproException) { _status ->
    UniffiLib.INSTANCE.uniffi_zk_location_fn_func_verify_halo2_proof(
    ...
    @Throws(MoproException::class) fun `verifyNoirProof`(`circuitPath`: kotlin.String, `proof`: kotlin.ByteArray, `onChain`: kotlin.Boolean, `vk`: kotlin.ByteArray, `lowMemoryMode`: kotlin.Boolean): kotlin.Boolean {
            return FfiConverterBoolean.lift(
    uniffiRustCallWithError(MoproException) { _status ->
    UniffiLib.INSTANCE.uniffi_zk_location_fn_func_verify_noir_proof(
