...
void DotByte_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void DotByte_3_run(uint ctx_index,Circom_CalcWit* ctx);
...
void DigitByte_10_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void DigitByte_10_run(uint ctx_index,Circom_CalcWit* ctx);
void Octet_11_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Octet_11_run(uint ctx_index,Circom_CalcWit* ctx);
void IPv4RegexRange_12_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void IPv4RegexRange_12_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 669;}

uint get_number_of_components() {return 125;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 475;}

uint get_size_of_constants() {return 22;}
...
ctx->componentMemory[coffset].templateName = "DotByte";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 1;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
int cmp_index_ref_load = -1;
{
std::string new_cmp_name = "byte_bits";
Num2Bits_0_create(mySignalStart+1,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "is_dot";
IsEqual_2_create(mySignalStart+10,1+ctx_index+1,ctx,new_cmp_name,myId);
...
cmp_index_ref_load = 1;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&circuitConstants[2]); // line circom 59
}}
...
ctx->componentMemory[coffset].templateName = "DigitByte";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 1;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
{
std::string new_cmp_name = "lower_bound";
LessEqThan_9_create(mySignalStart+11,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "upper_bound";
LessEqThan_9_create(mySignalStart+27,4+ctx_index+1,ctx,new_cmp_name,myId);
...
cmp_index_ref_load = 1;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&circuitConstants[2]); // line circom 36
}}
...
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 1],&circuitConstants[9]); // line circom 42
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 3; i++){
...
ctx->componentMemory[coffset].templateName = "Octet";
ctx->componentMemory[coffset].signalStart = soffset;
...
for (uint i = 0; i < 3; i++) {
std::string new_cmp_name = "digits"+ctx->generate_position_array(aux_dimensions, 1, i);
DigitByte_10_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
...
{
std::string new_cmp_name = "max_255";
LessEqThan_6_create(mySignalStart+133,24+ctx_index+1,ctx,new_cmp_name,myId);
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[11]); // line circom 73
while(Fr_isTrue(&expaux[0])){
{
...
DigitByte_10_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_add(&expaux[0],&lvar[0],&circuitConstants[2]); // line circom 73
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[11]); // line circom 73
...
cmp_index_ref_load = 0;
cmp_index_ref_load = 0;
Fr_mul(&expaux[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&circuitConstants[12]); // line circom 78
cmp_index_ref_load = 1;
cmp_index_ref_load = 1;
Fr_mul(&expaux[3],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&circuitConstants[5]); // line circom 78
Fr_add(&expaux[1],&expaux[2],&expaux[3]); // line circom 78
cmp_index_ref_load = 2;
cmp_index_ref_load = 2;
Fr_add(&expaux[0],&expaux[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 78
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 3;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + 0],&circuitConstants[2]); // line circom 82
}}
...
ctx->componentMemory[coffset].templateName = "IPv4RegexRange";
ctx->componentMemory[coffset].signalStart = soffset;
...
int cmp_index_ref_load = -1;
{
std::string new_cmp_name = "dot0";
DotByte_3_create(mySignalStart+16,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "dot1";
DotByte_3_create(mySignalStart+32,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "dot2";
DotByte_3_create(mySignalStart+48,8+ctx_index+1,ctx,new_cmp_name,myId);
...
for (uint i = 0; i < 4; i++) {
std::string new_cmp_name = "octets"+ctx->generate_position_array(aux_dimensions, 1, i);
Octet_11_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+ i] = aux_cmp_num;
csoffset += 151 ;
aux_cmp_num += 28;
}
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
DotByte_3_run(mySubcomponents[cmp_index_ref],ctx);
}
{
uint cmp_index_ref = 1;
{
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[16]); // line circom 102
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[0];
// load src
Fr_add(&expaux[0],&lvar[0],&circuitConstants[2]); // line circom 102
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[16]); // line circom 102
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Octet_11_run(mySubcomponents[cmp_index_ref],ctx);
...
IPv4RegexRange_12_create(1,0,ctx,"main",0);
IPv4RegexRange_12_run(0,ctx);
}
